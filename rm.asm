...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 53 08 00 	movl   $0x853,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 415:	8a 80 b8 0a 00 00    	mov    0xab8(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 56e:	75 09                	jne    579 <printf+0x100>
          s = "(null)";
 570:	c7 45 f4 6c 08 00 00 	movl   $0x86c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 637:	a1 d4 0a 00 00       	mov    0xad4,%eax
...
free(void *ap)
{
 ...
 702:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 707:	c9                   	leave  
 708:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 755:	e8 ce fe ff ff       	call   628 <free>
  return freep;
 75a:	a1 d4 0a 00 00       	mov    0xad4,%eax
}
 75f:	c9                   	leave  
 760:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 771:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 774:	a1 d4 0a 00 00       	mov    0xad4,%eax
 779:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 780:	75 23                	jne    7a5 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 782:	c7 45 f0 cc 0a 00 00 	movl   $0xacc,-0x10(%ebp)
 789:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78c:	a3 d4 0a 00 00       	mov    %eax,0xad4
 791:	a1 d4 0a 00 00       	mov    0xad4,%eax
 ...
 7f8:	a3 d4 0a 00 00       	mov    %eax,0xad4
      return (void*)(p + 1);
 ...
 803:	eb 38                	jmp    83d <malloc+0xdc>
    ...
    if(p == freep)
 805:	a1 d4 0a 00 00       	mov    0xad4,%eax
