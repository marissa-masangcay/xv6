...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 bc 14 00 00 	mov    0x14bc(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 90 14 00 00 	movl   $0x1490,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 97 14 00 	movl   $0x1497,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 4e 10 00 00       	call   10c9 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 a7 14 00 	movl   $0x14a7,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 fb 0f 00 00       	call   10c9 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 b7 14 00 00 	movl   $0x14b7,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 d4 14 00 	movl   $0x14d4,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 a4 0e 00 00       	call   10c9 <printf>
  memset(buf, 0, nbuf);
     ...
     286:	eb 1f                	jmp    2a7 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     28f:	00 
     290:	c7 04 24 d7 14 00 00 	movl   $0x14d7,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2ac:	a0 40 1a 00 00       	mov    0x1a40,%al
     2b1:	3c 63                	cmp    $0x63,%al
     2b3:	75 56                	jne    30b <main+0xa3>
     2b5:	a0 41 1a 00 00       	mov    0x1a41,%al
     2ba:	3c 64                	cmp    $0x64,%al
     2bc:	75 4d                	jne    30b <main+0xa3>
     2be:	a0 42 1a 00 00       	mov    0x1a42,%al
     2c3:	3c 20                	cmp    $0x20,%al
     2c5:	75 44                	jne    30b <main+0xa3>
      // Chdir must be called by the parent, not the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2c7:	c7 04 24 40 1a 00 00 	movl   $0x1a40,(%esp)
     2ce:	e8 98 0a 00 00       	call   d6b <strlen>
     2d3:	48                   	dec    %eax
     2d4:	c6 80 40 1a 00 00 00 	movb   $0x0,0x1a40(%eax)
      if(chdir(buf+3) < 0)
     2db:	c7 04 24 43 1a 00 00 	movl   $0x1a43,(%esp)
     2e2:	e8 bd 0c 00 00       	call   fa4 <chdir>
     2e7:	85 c0                	test   %eax,%eax
     2e9:	79 1e                	jns    309 <main+0xa1>
        printf(2, "cannot cd %s\n", buf+3);
     2eb:	c7 44 24 08 43 1a 00 	movl   $0x1a43,0x8(%esp)
     2f2:	00 
     2f3:	c7 44 24 04 df 14 00 	movl   $0x14df,0x4(%esp)
     2fa:	00 
     2fb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     302:	e8 c2 0d 00 00       	call   10c9 <printf>
      continue;
    ...
    if(fork1() == 0)
     ...
     312:	75 14                	jne    328 <main+0xc0>
      runcmd(parsecmd(buf));
     314:	c7 04 24 40 1a 00 00 	movl   $0x1a40,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     334:	00 
     335:	c7 04 24 40 1a 00 00 	movl   $0x1a40,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     35b:	c7 44 24 04 ed 14 00 	movl   $0x14ed,0x4(%esp)
     362:	00 
     363:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     36a:	e8 5a 0d 00 00       	call   10c9 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     388:	c7 04 24 f1 14 00 00 	movl   $0x14f1,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3a6:	e8 06 10 00 00       	call   13b1 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3e4:	e8 c8 0f 00 00       	call   13b1 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     44f:	e8 5d 0f 00 00       	call   13b1 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     49f:	e8 0d 0f 00 00       	call   13b1 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4ef:	e8 bd 0e 00 00       	call   13b1 <malloc>
     ...
     539:	ff 45 f4             	incl   -0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     550:	c7 04 24 08 1a 00 00 	movl   $0x1a08,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5f2:	c7 04 24 08 1a 00 00 	movl   $0x1a08,(%esp)
     ...
     60e:	c7 04 24 0e 1a 00 00 	movl   $0x1a0e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     64a:	c7 04 24 08 1a 00 00 	movl   $0x1a08,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     68e:	c7 04 24 08 1a 00 00 	movl   $0x1a08,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     707:	c7 44 24 08 f6 14 00 	movl   $0x14f6,0x8(%esp)
     70e:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     730:	c7 44 24 04 f7 14 00 	movl   $0x14f7,0x4(%esp)
     737:	00 
     738:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     73f:	e8 85 09 00 00       	call   10c9 <printf>
    panic("syntax");
     744:	c7 04 24 06 15 00 00 	movl   $0x1506,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7b1:	c7 44 24 08 0d 15 00 	movl   $0x150d,0x8(%esp)
     7b8:	00 
  ...
  if(peek(ps, es, ";")){
     7cf:	c7 44 24 08 0f 15 00 	movl   $0x150f,0x8(%esp)
     7d6:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     853:	c7 44 24 08 11 15 00 	movl   $0x1511,0x8(%esp)
     85a:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     911:	c7 04 24 13 15 00 00 	movl   $0x1513,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9bd:	c7 44 24 08 30 15 00 	movl   $0x1530,0x8(%esp)
     9c4:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     9ea:	c7 44 24 08 33 15 00 	movl   $0x1533,0x8(%esp)
     9f1:	00 
    ...
    panic("parseblock");
     a08:	c7 04 24 35 15 00 00 	movl   $0x1535,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a4b:	c7 44 24 08 40 15 00 	movl   $0x1540,0x8(%esp)
     a52:	00 
    ...
    panic("syntax - missing )");
     a69:	c7 04 24 42 15 00 00 	movl   $0x1542,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     abe:	c7 44 24 08 33 15 00 	movl   $0x1533,0x8(%esp)
     ac5:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b5b:	74 0c                	je     b69 <parseexec+0xb1>
      panic("syntax");
     b5d:	c7 04 24 06 15 00 00 	movl   $0x1506,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     b8d:	7e 0c                	jle    b9b <parseexec+0xe3>
      panic("too many args");
     b8f:	c7 04 24 55 15 00 00 	movl   $0x1555,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bb7:	c7 44 24 08 63 15 00 	movl   $0x1563,0x8(%esp)
     bbe:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c21:	8b 04 85 68 15 00 00 	mov    0x1568(,%eax,4),%eax
     c28:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
     ...
     fef:	83 ec 18             	sub    $0x18,%esp
     ff2:	8b 45 0c             	mov    0xc(%ebp),%eax
     ff5:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     ff8:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     fff:	00 
    1000:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1003:	89 44 24 04          	mov    %eax,0x4(%esp)
    1007:	8b 45 08             	mov    0x8(%ebp),%eax
    100a:	89 04 24             	mov    %eax,(%esp)
    100d:	e8 42 ff ff ff       	call   f54 <write>
}
    1012:	c9                   	leave  
    1013:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    1027:	74 17                	je     1040 <printint+0x2c>
    1029:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    102d:	79 11                	jns    1040 <printint+0x2c>
    neg = 1;
    ...
    103e:	eb 06                	jmp    1046 <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    ...
    1065:	8a 80 18 1a 00 00    	mov    0x1a18(%eax),%al
    106b:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    106f:	8b 75 10             	mov    0x10(%ebp),%esi
    ...
    1083:	75 c8                	jne    104d <printint+0x39>
  if(neg)
    1085:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1089:	74 10                	je     109b <printint+0x87>
    buf[i++] = '-';
  ...
  while(--i >= 0)
    10b9:	ff 4d f4             	decl   -0xc(%ebp)
    10bc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    10c0:	79 db                	jns    109d <printint+0x89>
    putc(fd, buf[i]);
}
    10c2:	83 c4 30             	add    $0x30,%esp
    10c5:	5b                   	pop    %ebx
    10c6:	5e                   	pop    %esi
    10c7:	5d                   	pop    %ebp
    10c8:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10e6:	e9 77 01 00 00       	jmp    1262 <printf+0x199>
    c = fmt[i] & 0xff;
    ...
    10f8:	25 ff 00 00 00       	and    $0xff,%eax
    10fd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1100:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1104:	75 2c                	jne    1132 <printf+0x69>
      if(c == '%'){
    1106:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    110a:	75 0c                	jne    1118 <printf+0x4f>
        state = '%';
    110c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1113:	e9 47 01 00 00       	jmp    125f <printf+0x196>
      } else {
        putc(fd, c);
    1118:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    111b:	0f be c0             	movsbl %al,%eax
    111e:	89 44 24 04          	mov    %eax,0x4(%esp)
    1122:	8b 45 08             	mov    0x8(%ebp),%eax
    1125:	89 04 24             	mov    %eax,(%esp)
    1128:	e8 bf fe ff ff       	call   fec <putc>
    112d:	e9 2d 01 00 00       	jmp    125f <printf+0x196>
      }
    } else if(state == '%'){
    1132:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    1136:	0f 85 23 01 00 00    	jne    125f <printf+0x196>
      if(c == 'd'){
    113c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1140:	75 2d                	jne    116f <printf+0xa6>
        printint(fd, *ap, 10, 1);
    1142:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1145:	8b 00                	mov    (%eax),%eax
    1147:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    114e:	00 
    114f:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1156:	00 
    1157:	89 44 24 04          	mov    %eax,0x4(%esp)
    115b:	8b 45 08             	mov    0x8(%ebp),%eax
    115e:	89 04 24             	mov    %eax,(%esp)
    1161:	e8 ae fe ff ff       	call   1014 <printint>
        ap++;
    1166:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    116a:	e9 e9 00 00 00       	jmp    1258 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
    116f:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    1173:	74 06                	je     117b <printf+0xb2>
    1175:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    1179:	75 2d                	jne    11a8 <printf+0xdf>
        printint(fd, *ap, 16, 0);
    117b:	8b 45 e8             	mov    -0x18(%ebp),%eax
    117e:	8b 00                	mov    (%eax),%eax
    1180:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    1187:	00 
    1188:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    118f:	00 
    1190:	89 44 24 04          	mov    %eax,0x4(%esp)
    1194:	8b 45 08             	mov    0x8(%ebp),%eax
    1197:	89 04 24             	mov    %eax,(%esp)
    119a:	e8 75 fe ff ff       	call   1014 <printint>
        ap++;
    119f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11a3:	e9 b0 00 00 00       	jmp    1258 <printf+0x18f>
      } else if(c == 's'){
    11a8:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    11ac:	75 42                	jne    11f0 <printf+0x127>
        s = (char*)*ap;
    11ae:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11b1:	8b 00                	mov    (%eax),%eax
    11b3:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    11b6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    11ba:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    11be:	75 09                	jne    11c9 <printf+0x100>
          s = "(null)";
    11c0:	c7 45 f4 80 15 00 00 	movl   $0x1580,-0xc(%ebp)
        while(*s != 0){
    11c7:	eb 1c                	jmp    11e5 <printf+0x11c>
    11c9:	eb 1a                	jmp    11e5 <printf+0x11c>
          putc(fd, *s);
    11cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11ce:	8a 00                	mov    (%eax),%al
    11d0:	0f be c0             	movsbl %al,%eax
    11d3:	89 44 24 04          	mov    %eax,0x4(%esp)
    11d7:	8b 45 08             	mov    0x8(%ebp),%eax
    11da:	89 04 24             	mov    %eax,(%esp)
    11dd:	e8 0a fe ff ff       	call   fec <putc>
          s++;
    11e2:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    11e8:	8a 00                	mov    (%eax),%al
    11ea:	84 c0                	test   %al,%al
    11ec:	75 dd                	jne    11cb <printf+0x102>
    11ee:	eb 68                	jmp    1258 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    11f0:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    11f4:	75 1d                	jne    1213 <printf+0x14a>
        putc(fd, *ap);
    11f6:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11f9:	8b 00                	mov    (%eax),%eax
    11fb:	0f be c0             	movsbl %al,%eax
    11fe:	89 44 24 04          	mov    %eax,0x4(%esp)
    1202:	8b 45 08             	mov    0x8(%ebp),%eax
    1205:	89 04 24             	mov    %eax,(%esp)
    1208:	e8 df fd ff ff       	call   fec <putc>
        ap++;
    120d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1211:	eb 45                	jmp    1258 <printf+0x18f>
      } else if(c == '%'){
    1213:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1217:	75 17                	jne    1230 <printf+0x167>
        putc(fd, c);
    1219:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    121c:	0f be c0             	movsbl %al,%eax
    121f:	89 44 24 04          	mov    %eax,0x4(%esp)
    1223:	8b 45 08             	mov    0x8(%ebp),%eax
    1226:	89 04 24             	mov    %eax,(%esp)
    1229:	e8 be fd ff ff       	call   fec <putc>
    122e:	eb 28                	jmp    1258 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1230:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    1237:	00 
    1238:	8b 45 08             	mov    0x8(%ebp),%eax
    123b:	89 04 24             	mov    %eax,(%esp)
    123e:	e8 a9 fd ff ff       	call   fec <putc>
        putc(fd, c);
    ...
    1253:	e8 94 fd ff ff       	call   fec <putc>
      }
      state = 0;
    1258:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    12bb:	76 d4                	jbe    1291 <free+0x19>
    12bd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12c0:	8b 00                	mov    (%eax),%eax
    12c2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    12c5:	76 ca                	jbe    1291 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  ...
  freep = p;
    ...
    1352:	a3 ac 1a 00 00       	mov    %eax,0x1aac
}
    1357:	c9                   	leave  
    1358:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    135c:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    135f:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    1366:	77 07                	ja     136f <morecore+0x16>
    nu = 4096;
    1368:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    136f:	8b 45 08             	mov    0x8(%ebp),%eax
    1372:	c1 e0 03             	shl    $0x3,%eax
    1375:	89 04 24             	mov    %eax,(%esp)
    1378:	e8 3f fc ff ff       	call   fbc <sbrk>
    137d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    1380:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1384:	75 07                	jne    138d <morecore+0x34>
    return 0;
    1386:	b8 00 00 00 00       	mov    $0x0,%eax
    138b:	eb 22                	jmp    13af <morecore+0x56>
  hp = (Header*)p;
    138d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1390:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    1393:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1396:	8b 55 08             	mov    0x8(%ebp),%edx
    1399:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    139c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    139f:	83 c0 08             	add    $0x8,%eax
    13a2:	89 04 24             	mov    %eax,(%esp)
    13a5:	e8 ce fe ff ff       	call   1278 <free>
  return freep;
    13aa:	a1 ac 1a 00 00       	mov    0x1aac,%eax
}
    13af:	c9                   	leave  
    13b0:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    13ba:	83 c0 07             	add    $0x7,%eax
    13bd:	c1 e8 03             	shr    $0x3,%eax
    13c0:	40                   	inc    %eax
    13c1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    13c4:	a1 ac 1a 00 00       	mov    0x1aac,%eax
    13c9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13cc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    13d0:	75 23                	jne    13f5 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    13d2:	c7 45 f0 a4 1a 00 00 	movl   $0x1aa4,-0x10(%ebp)
    13d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13dc:	a3 ac 1a 00 00       	mov    %eax,0x1aac
    13e1:	a1 ac 1a 00 00       	mov    0x1aac,%eax
    13e6:	a3 a4 1a 00 00       	mov    %eax,0x1aa4
    base.s.size = 0;
    13eb:	c7 05 a8 1a 00 00 00 	movl   $0x0,0x1aa8
    13f2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1406:	72 4d                	jb     1455 <malloc+0xa4>
      if(p->s.size == nunits)
    1408:	8b 45 f4             	mov    -0xc(%ebp),%eax
    140b:	8b 40 04             	mov    0x4(%eax),%eax
    140e:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1411:	75 0c                	jne    141f <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    1413:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1416:	8b 10                	mov    (%eax),%edx
    1418:	8b 45 f0             	mov    -0x10(%ebp),%eax
    141b:	89 10                	mov    %edx,(%eax)
    141d:	eb 26                	jmp    1445 <malloc+0x94>
      else {
        p->s.size -= nunits;
    141f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1422:	8b 40 04             	mov    0x4(%eax),%eax
    1425:	2b 45 ec             	sub    -0x14(%ebp),%eax
    1428:	89 c2                	mov    %eax,%edx
    142a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    142d:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    1430:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1433:	8b 40 04             	mov    0x4(%eax),%eax
    1436:	c1 e0 03             	shl    $0x3,%eax
    1439:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    143c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    143f:	8b 55 ec             	mov    -0x14(%ebp),%edx
    1442:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    1445:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1448:	a3 ac 1a 00 00       	mov    %eax,0x1aac
      return (void*)(p + 1);
    144d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1450:	83 c0 08             	add    $0x8,%eax
    1453:	eb 38                	jmp    148d <malloc+0xdc>
    }
    if(p == freep)
    1455:	a1 ac 1a 00 00       	mov    0x1aac,%eax
    145a:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    145d:	75 1b                	jne    147a <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    145f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1462:	89 04 24             	mov    %eax,(%esp)
    1465:	e8 ef fe ff ff       	call   1359 <morecore>
    146a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    146d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1471:	75 07                	jne    147a <malloc+0xc9>
        return 0;
    1473:	b8 00 00 00 00       	mov    $0x0,%eax
    1478:	eb 13                	jmp    148d <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1488:	e9 70 ff ff ff       	jmp    13fd <malloc+0x4c>
}
    148d:	c9                   	leave  
    148e:	c3                   	ret    
