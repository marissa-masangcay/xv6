...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	c7 44 24 04 3a 45 00 	movl   $0x453a,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 42 41 00 00       	call   415d <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 45 45 00 00 	movl   $0x4545,(%esp)
      22:	e8 09 40 00 00       	call   4030 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 a4 64 00 00       	mov    0x64a4,%eax
      30:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 1d 41 00 00       	call   415d <printf>
    exit();
      40:	e8 83 3f 00 00       	call   3fc8 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 45 45 00 00 	movl   $0x4545,(%esp)
      4c:	e8 e7 3f 00 00       	call   4038 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 a4 64 00 00       	mov    0x64a4,%eax
      5a:	c7 44 24 04 5b 45 00 	movl   $0x455b,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 f3 40 00 00       	call   415d <printf>
    exit();
      6a:	e8 59 3f 00 00       	call   3fc8 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 71 45 00 00 	movl   $0x4571,(%esp)
      76:	e8 9d 3f 00 00       	call   4018 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 a4 64 00 00       	mov    0x64a4,%eax
      84:	c7 44 24 04 7c 45 00 	movl   $0x457c,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 c9 40 00 00       	call   415d <printf>
    exit();
      94:	e8 2f 3f 00 00       	call   3fc8 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 96 45 00 00 	movl   $0x4596,(%esp)
      a0:	e8 93 3f 00 00       	call   4038 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 a4 64 00 00       	mov    0x64a4,%eax
      ae:	c7 44 24 04 98 45 00 	movl   $0x4598,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 9f 40 00 00       	call   415d <printf>
    exit();
      be:	e8 05 3f 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 a4 64 00 00       	mov    0x64a4,%eax
      c8:	c7 44 24 04 a8 45 00 	movl   $0x45a8,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 85 40 00 00       	call   415d <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 a4 64 00 00       	mov    0x64a4,%eax
      e5:	c7 44 24 04 b6 45 00 	movl   $0x45b6,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 68 40 00 00       	call   415d <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 a4 64 00 00       	mov    0x64a4,%eax
     108:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 45 40 00 00       	call   415d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 45 45 00 00 	movl   $0x4545,(%esp)
     12e:	e8 fd 3e 00 00       	call   4030 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 a4 64 00 00       	mov    0x64a4,%eax
     13c:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 11 40 00 00       	call   415d <printf>
      exit();
     14c:	e8 77 3e 00 00       	call   3fc8 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 45 45 00 00 	movl   $0x4545,(%esp)
     158:	e8 db 3e 00 00       	call   4038 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 a4 64 00 00       	mov    0x64a4,%eax
     166:	c7 44 24 04 d2 45 00 	movl   $0x45d2,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 e7 3f 00 00       	call   415d <printf>
      exit();
     176:	e8 4d 3e 00 00       	call   3fc8 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 71 45 00 00 	movl   $0x4571,(%esp)
     182:	e8 91 3e 00 00       	call   4018 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 a4 64 00 00       	mov    0x64a4,%eax
     190:	c7 44 24 04 7c 45 00 	movl   $0x457c,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 bd 3f 00 00       	call   415d <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 a4 64 00 00       	mov    0x64a4,%eax
     1b4:	c7 44 24 04 e6 45 00 	movl   $0x45e6,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 99 3f 00 00       	call   415d <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 a4 64 00 00       	mov    0x64a4,%eax
     1d1:	c7 44 24 04 f8 45 00 	movl   $0x45f8,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 7c 3f 00 00       	call   415d <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 07 46 00 00 	movl   $0x4607,(%esp)
     1e8:	e8 43 3e 00 00       	call   4030 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 a4 64 00 00       	mov    0x64a4,%eax
     1f6:	c7 44 24 04 0d 46 00 	movl   $0x460d,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 57 3f 00 00       	call   415d <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 a4 64 00 00       	mov    0x64a4,%eax
     21e:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 2f 3f 00 00       	call   415d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 07 46 00 00 	movl   $0x4607,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 a4 64 00 00       	mov    0x64a4,%eax
     25b:	c7 44 24 04 24 46 00 	movl   $0x4624,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 f2 3e 00 00       	call   415d <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 07 46 00 00 	movl   $0x4607,(%esp)
     288:	e8 8b 3d 00 00       	call   4018 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 a4 64 00 00       	mov    0x64a4,%eax
     296:	c7 44 24 04 48 46 00 	movl   $0x4648,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 b7 3e 00 00       	call   415d <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 a4 64 00 00       	mov    0x64a4,%eax
     2b5:	c7 44 24 04 57 46 00 	movl   $0x4657,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 98 3e 00 00       	call   415d <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 a4 64 00 00       	mov    0x64a4,%eax
     2d2:	c7 44 24 04 69 46 00 	movl   $0x4669,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 7b 3e 00 00       	call   415d <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 24 45 00 00 	movl   $0x4524,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 a4 64 00 00       	mov    0x64a4,%eax
     304:	c7 44 24 04 74 46 00 	movl   $0x4674,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 49 3e 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 87 46 00 00 	movl   $0x4687,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 a4 64 00 00       	mov    0x64a4,%eax
     346:	c7 44 24 04 94 46 00 	movl   $0x4694,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 07 3e 00 00       	call   415d <printf>
    exit();
     356:	e8 6d 3c 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 a4 64 00 00       	mov    0x64a4,%eax
     360:	c7 44 24 04 b2 46 00 	movl   $0x46b2,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 ed 3d 00 00       	call   415d <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 a4 64 00 00       	mov    0x64a4,%eax
     37d:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 d0 3d 00 00       	call   415d <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 d1 46 00 00 	movl   $0x46d1,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 a4 64 00 00       	mov    0x64a4,%eax
     3af:	c7 44 24 04 d7 46 00 	movl   $0x46d7,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 9e 3d 00 00       	call   415d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 a4 64 00 00       	mov    0x64a4,%eax
     3d0:	c7 44 24 04 f2 46 00 	movl   $0x46f2,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 7d 3d 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 0e 47 00 	movl   $0x470e,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 a4 64 00 00       	mov    0x64a4,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 3c 3d 00 00       	call   415d <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 40 47 00 	movl   $0x4740,0x4(%esp)
     435:	00 
     ...
     446:	a1 a4 64 00 00       	mov    0x64a4,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 4c 47 00 	movl   $0x474c,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 fb 3c 00 00       	call   415d <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     474:	a1 a4 64 00 00       	mov    0x64a4,%eax
     479:	c7 44 24 04 70 47 00 	movl   $0x4770,0x4(%esp)
     480:	00 
     481:	89 04 24             	mov    %eax,(%esp)
     484:	e8 d4 3c 00 00       	call   415d <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49b:	00 
     49c:	c7 04 24 d1 46 00 00 	movl   $0x46d1,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b1:	a1 a4 64 00 00       	mov    0x64a4,%eax
     4b6:	c7 44 24 04 7b 47 00 	movl   $0x477b,0x4(%esp)
     4bd:	00 
     4be:	89 04 24             	mov    %eax,(%esp)
     4c1:	e8 97 3c 00 00       	call   415d <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4cd:	00 
     4ce:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
     4d5:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4ef:	a1 a4 64 00 00       	mov    0x64a4,%eax
     4f4:	c7 44 24 04 94 47 00 	movl   $0x4794,0x4(%esp)
     4fb:	00 
     4fc:	89 04 24             	mov    %eax,(%esp)
     4ff:	e8 59 3c 00 00       	call   415d <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     509:	a1 a4 64 00 00       	mov    0x64a4,%eax
     50e:	c7 44 24 04 af 47 00 	movl   $0x47af,0x4(%esp)
     515:	00 
     516:	89 04 24             	mov    %eax,(%esp)
     519:	e8 3f 3c 00 00       	call   415d <printf>
  } else {
  ...
  if(unlink("small") < 0){
     529:	c7 04 24 d1 46 00 00 	movl   $0x46d1,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53b:	a1 a4 64 00 00       	mov    0x64a4,%eax
     540:	c7 44 24 04 c2 47 00 	movl   $0x47c2,0x4(%esp)
     547:	00 
     548:	89 04 24             	mov    %eax,(%esp)
     54b:	e8 0d 3c 00 00       	call   415d <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     555:	a1 a4 64 00 00       	mov    0x64a4,%eax
     55a:	c7 44 24 04 cf 47 00 	movl   $0x47cf,0x4(%esp)
     561:	00 
     562:	89 04 24             	mov    %eax,(%esp)
     565:	e8 f3 3b 00 00       	call   415d <printf>
    exit();
     56a:	e8 59 3a 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "small file test ok\n");
     56f:	a1 a4 64 00 00       	mov    0x64a4,%eax
     574:	c7 44 24 04 e4 47 00 	movl   $0x47e4,0x4(%esp)
     57b:	00 
     57c:	89 04 24             	mov    %eax,(%esp)
     57f:	e8 d9 3b 00 00       	call   415d <printf>
}
     584:	c9                   	leave  
     585:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58c:	a1 a4 64 00 00       	mov    0x64a4,%eax
     591:	c7 44 24 04 f8 47 00 	movl   $0x47f8,0x4(%esp)
     598:	00 
     599:	89 04 24             	mov    %eax,(%esp)
     59c:	e8 bc 3b 00 00       	call   415d <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a1:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a8:	00 
     5a9:	c7 04 24 08 48 00 00 	movl   $0x4808,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5be:	a1 a4 64 00 00       	mov    0x64a4,%eax
     5c3:	c7 44 24 04 0c 48 00 	movl   $0x480c,0x4(%esp)
     5ca:	00 
     5cb:	89 04 24             	mov    %eax,(%esp)
     5ce:	e8 8a 3b 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60d:	a1 a4 64 00 00       	mov    0x64a4,%eax
     612:	8b 55 f4             	mov    -0xc(%ebp),%edx
     615:	89 54 24 08          	mov    %edx,0x8(%esp)
     619:	c7 44 24 04 26 48 00 	movl   $0x4826,0x4(%esp)
     620:	00 
     621:	89 04 24             	mov    %eax,(%esp)
     624:	e8 34 3b 00 00       	call   415d <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64d:	00 
     64e:	c7 04 24 08 48 00 00 	movl   $0x4808,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     663:	a1 a4 64 00 00       	mov    0x64a4,%eax
     668:	c7 44 24 04 44 48 00 	movl   $0x4844,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 e5 3a 00 00       	call   415d <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     68b:	00 
     68c:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
     693:	00 
    ...
    if(i == 0){
     ...
     6b1:	a1 a4 64 00 00       	mov    0x64a4,%eax
     6b6:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6b9:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bd:	c7 44 24 04 5d 48 00 	movl   $0x485d,0x4(%esp)
     6c4:	00 
     6c5:	89 04 24             	mov    %eax,(%esp)
     6c8:	e8 90 3a 00 00       	call   415d <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6de:	c7 04 24 08 48 00 00 	movl   $0x4808,(%esp)
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     75e:	a1 a4 64 00 00       	mov    0x64a4,%eax
     763:	c7 44 24 04 ac 48 00 	movl   $0x48ac,0x4(%esp)
     76a:	00 
     76b:	89 04 24             	mov    %eax,(%esp)
     76e:	e8 ea 39 00 00       	call   415d <printf>
    exit();
     773:	e8 50 38 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "big files ok\n");
     778:	a1 a4 64 00 00       	mov    0x64a4,%eax
     77d:	c7 44 24 04 bf 48 00 	movl   $0x48bf,0x4(%esp)
     784:	00 
     785:	89 04 24             	mov    %eax,(%esp)
     788:	e8 d0 39 00 00       	call   415d <printf>
}
     78d:	c9                   	leave  
     78e:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     795:	a1 a4 64 00 00       	mov    0x64a4,%eax
     79a:	c7 44 24 04 d0 48 00 	movl   $0x48d0,0x4(%esp)
     7a1:	00 
     7a2:	89 04 24             	mov    %eax,(%esp)
     7a5:	e8 b3 39 00 00       	call   415d <printf>

  name[0] = 'a';
     7aa:	c6 05 80 ac 00 00 61 	movb   $0x61,0xac80
  name[2] = '\0';
     7b1:	c6 05 82 ac 00 00 00 	movb   $0x0,0xac82
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7c7:	a2 81 ac 00 00       	mov    %al,0xac81
    fd = open(name, O_CREATE|O_RDWR);
     7cc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d3:	00 
     7d4:	c7 04 24 80 ac 00 00 	movl   $0xac80,(%esp)
  ...
  name[0] = 'a';
     7f7:	c6 05 80 ac 00 00 61 	movb   $0x61,0xac80
  name[2] = '\0';
     7fe:	c6 05 82 ac 00 00 00 	movb   $0x0,0xac82
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     814:	a2 81 ac 00 00       	mov    %al,0xac81
    unlink(name);
     819:	c7 04 24 80 ac 00 00 	movl   $0xac80,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     82e:	a1 a4 64 00 00       	mov    0x64a4,%eax
     833:	c7 44 24 04 f8 48 00 	movl   $0x48f8,0x4(%esp)
     83a:	00 
     83b:	89 04 24             	mov    %eax,(%esp)
     83e:	e8 1a 39 00 00       	call   415d <printf>
}
     843:	c9                   	leave  
     844:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84b:	a1 a4 64 00 00       	mov    0x64a4,%eax
     850:	c7 44 24 04 1e 49 00 	movl   $0x491e,0x4(%esp)
     857:	00 
     858:	89 04 24             	mov    %eax,(%esp)
     85b:	e8 fd 38 00 00       	call   415d <printf>

  if(mkdir("dir0") < 0){
     860:	c7 04 24 2a 49 00 00 	movl   $0x492a,(%esp)
     867:	e8 c4 37 00 00       	call   4030 <mkdir>
     86c:	85 c0                	test   %eax,%eax
     86e:	79 1a                	jns    88a <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     870:	a1 a4 64 00 00       	mov    0x64a4,%eax
     875:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
     87c:	00 
     87d:	89 04 24             	mov    %eax,(%esp)
     880:	e8 d8 38 00 00       	call   415d <printf>
    exit();
     885:	e8 3e 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("dir0") < 0){
     88a:	c7 04 24 2a 49 00 00 	movl   $0x492a,(%esp)
     891:	e8 a2 37 00 00       	call   4038 <chdir>
     896:	85 c0                	test   %eax,%eax
     898:	79 1a                	jns    8b4 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89a:	a1 a4 64 00 00       	mov    0x64a4,%eax
     89f:	c7 44 24 04 2f 49 00 	movl   $0x492f,0x4(%esp)
     8a6:	00 
     8a7:	89 04 24             	mov    %eax,(%esp)
     8aa:	e8 ae 38 00 00       	call   415d <printf>
    exit();
     8af:	e8 14 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("..") < 0){
     8b4:	c7 04 24 42 49 00 00 	movl   $0x4942,(%esp)
     8bb:	e8 78 37 00 00       	call   4038 <chdir>
     8c0:	85 c0                	test   %eax,%eax
     8c2:	79 1a                	jns    8de <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c4:	a1 a4 64 00 00       	mov    0x64a4,%eax
     8c9:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
     8d0:	00 
     8d1:	89 04 24             	mov    %eax,(%esp)
     8d4:	e8 84 38 00 00       	call   415d <printf>
    exit();
     8d9:	e8 ea 36 00 00       	call   3fc8 <exit>
  }

  if(unlink("dir0") < 0){
     8de:	c7 04 24 2a 49 00 00 	movl   $0x492a,(%esp)
     8e5:	e8 2e 37 00 00       	call   4018 <unlink>
     8ea:	85 c0                	test   %eax,%eax
     8ec:	79 1a                	jns    908 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8ee:	a1 a4 64 00 00       	mov    0x64a4,%eax
     8f3:	c7 44 24 04 56 49 00 	movl   $0x4956,0x4(%esp)
     8fa:	00 
     8fb:	89 04 24             	mov    %eax,(%esp)
     8fe:	e8 5a 38 00 00       	call   415d <printf>
    exit();
     903:	e8 c0 36 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     908:	a1 a4 64 00 00       	mov    0x64a4,%eax
     90d:	c7 44 24 04 6a 49 00 	movl   $0x496a,0x4(%esp)
     914:	00 
     915:	89 04 24             	mov    %eax,(%esp)
     918:	e8 40 38 00 00       	call   415d <printf>
}
     91d:	c9                   	leave  
     91e:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     925:	a1 a4 64 00 00       	mov    0x64a4,%eax
     92a:	c7 44 24 04 79 49 00 	movl   $0x4979,0x4(%esp)
     931:	00 
     932:	89 04 24             	mov    %eax,(%esp)
     935:	e8 23 38 00 00       	call   415d <printf>
  if(exec("echo", echoargv) < 0){
     93a:	c7 44 24 04 90 64 00 	movl   $0x6490,0x4(%esp)
     941:	00 
     942:	c7 04 24 24 45 00 00 	movl   $0x4524,(%esp)
     949:	e8 b2 36 00 00       	call   4000 <exec>
     94e:	85 c0                	test   %eax,%eax
     950:	79 1a                	jns    96c <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     952:	a1 a4 64 00 00       	mov    0x64a4,%eax
     957:	c7 44 24 04 84 49 00 	movl   $0x4984,0x4(%esp)
     95e:	00 
     95f:	89 04 24             	mov    %eax,(%esp)
     962:	e8 f6 37 00 00       	call   415d <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     983:	c7 44 24 04 96 49 00 	movl   $0x4996,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 c6 37 00 00       	call   415d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9de:	81 c2 80 8c 00 00    	add    $0x8c80,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9fc:	00 
     9fd:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
     a04:	00 
     ...
     a14:	c7 44 24 04 a5 49 00 	movl   $0x49a5,0x4(%esp)
     a1b:	00 
     a1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a23:	e8 35 37 00 00       	call   415d <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6c:	05 80 8c 00 00       	add    $0x8c80,%eax
     ...
     a88:	c7 44 24 04 b3 49 00 	movl   $0x49b3,0x4(%esp)
     a8f:	00 
     a90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a97:	e8 c1 36 00 00       	call   415d <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad5:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
     adc:	00 
    ...
    if(total != 5 * 1033){
     ...
     b02:	c7 44 24 04 c1 49 00 	movl   $0x49c1,0x4(%esp)
     b09:	00 
     b0a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b11:	e8 47 36 00 00       	call   415d <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2b:	c7 44 24 04 e7 49 00 	movl   $0x49e7,0x4(%esp)
     b32:	00 
     b33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3a:	e8 1e 36 00 00       	call   415d <printf>
    ...
    printf(1, "fork() failed\n");
     b41:	c7 44 24 04 d8 49 00 	movl   $0x49d8,0x4(%esp)
     b48:	00 
     b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b50:	e8 08 36 00 00       	call   415d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b62:	c7 44 24 04 f1 49 00 	movl   $0x49f1,0x4(%esp)
     b69:	00 
     b6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b71:	e8 e7 35 00 00       	call   415d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc4:	00 
     bc5:	c7 44 24 04 fb 49 00 	movl   $0x49fb,0x4(%esp)
     bcc:	00 
     ...
     bda:	c7 44 24 04 fd 49 00 	movl   $0x49fd,0x4(%esp)
     be1:	00 
     be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     be9:	e8 6f 35 00 00       	call   415d <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c10:	00 
     c11:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
     c18:	00 
    ...
    printf(1, "preempt read error");
     c26:	c7 44 24 04 11 4a 00 	movl   $0x4a11,0x4(%esp)
     c2d:	00 
     c2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c35:	e8 23 35 00 00       	call   415d <printf>
  ...
  printf(1, "kill... ");
     c47:	c7 44 24 04 24 4a 00 	movl   $0x4a24,0x4(%esp)
     c4e:	00 
     c4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c56:	e8 02 35 00 00       	call   415d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c7c:	c7 44 24 04 2d 4a 00 	movl   $0x4a2d,0x4(%esp)
     c83:	00 
     c84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8b:	e8 cd 34 00 00       	call   415d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     c9f:	c7 44 24 04 36 4a 00 	movl   $0x4a36,0x4(%esp)
     ca6:	00 
     ca7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cae:	e8 aa 34 00 00       	call   415d <printf>
}
     cb3:	c9                   	leave  
     cb4:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd0:	79 16                	jns    ce8 <exitwait+0x33>
      printf(1, "fork failed\n");
     cd2:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
     cd9:	00 
     cda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce1:	e8 77 34 00 00       	call   415d <printf>
      return;
    ...
    if(pid){
     ...
     cf8:	c7 44 24 04 42 4a 00 	movl   $0x4a42,0x4(%esp)
     cff:	00 
     d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d07:	e8 51 34 00 00       	call   415d <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d1c:	c7 44 24 04 52 4a 00 	movl   $0x4a52,0x4(%esp)
     d23:	00 
     d24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d2b:	e8 2d 34 00 00       	call   415d <printf>
}
     d30:	c9                   	leave  
     d31:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d38:	c7 44 24 04 5f 4a 00 	movl   $0x4a5f,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 11 34 00 00       	call   415d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d84:	e8 bc 36 00 00       	call   4445 <malloc>
    ...
    while(m1){
     ...
     da2:	e8 65 35 00 00       	call   430c <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df2:	e8 15 35 00 00       	call   430c <free>
    printf(1, "mem ok\n");
     df7:	c7 44 24 04 83 4a 00 	movl   $0x4a83,0x4(%esp)
     dfe:	00 
     dff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e06:	e8 52 33 00 00       	call   415d <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e1d:	c7 44 24 04 8b 4a 00 	movl   $0x4a8b,0x4(%esp)
     e24:	00 
     e25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2c:	e8 2c 33 00 00       	call   415d <printf>

  unlink("sharedfd");
     e31:	c7 04 24 9a 4a 00 00 	movl   $0x4a9a,(%esp)
     e38:	e8 db 31 00 00       	call   4018 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e3d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e44:	00 
     e45:	c7 04 24 9a 4a 00 00 	movl   $0x4a9a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5a:	c7 44 24 04 a4 4a 00 	movl   $0x4aa4,0x4(%esp)
     e61:	00 
     e62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e69:	e8 ef 32 00 00       	call   415d <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecc:	c7 44 24 04 d0 4a 00 	movl   $0x4ad0,0x4(%esp)
     ed3:	00 
     ed4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edb:	e8 7d 32 00 00       	call   415d <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f10:	00 
     f11:	c7 04 24 9a 4a 00 00 	movl   $0x4a9a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f26:	c7 44 24 04 f0 4a 00 	movl   $0x4af0,0x4(%esp)
     f2d:	00 
     f2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f35:	e8 23 32 00 00       	call   415d <printf>
    return;
  ...
  unlink("sharedfd");
     fb2:	c7 04 24 9a 4a 00 00 	movl   $0x4a9a,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd0:	c7 44 24 04 1b 4b 00 	movl   $0x4b1b,0x4(%esp)
     fd7:	00 
     fd8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fdf:	e8 79 31 00 00       	call   415d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ff4:	c7 44 24 04 28 4b 00 	movl   $0x4b28,0x4(%esp)
     ffb:	00 
     ffc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1003:	e8 55 31 00 00       	call   415d <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    101b:	bb a4 4b 00 00       	mov    $0x4ba4,%ebx
  ...
  printf(1, "fourfiles test\n");
    102d:	c7 44 24 04 3d 4b 00 	movl   $0x4b3d,0x4(%esp)
    1034:	00 
    1035:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    103c:	e8 1c 31 00 00       	call   415d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106e:	79 19                	jns    1089 <fourfiles+0x7a>
      printf(1, "fork failed\n");
    1070:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
    1077:	00 
    1078:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    107f:	e8 d9 30 00 00       	call   415d <printf>
      exit();
    ...
    10af:	c7 44 24 04 4d 4b 00 	movl   $0x4b4d,0x4(%esp)
    10b6:	00 
    10b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10be:	e8 9a 30 00 00       	call   415d <printf>
        exit();
    ...
    10da:	c7 04 24 80 8c 00 00 	movl   $0x8c80,(%esp)
    ...
    10f6:	00 
    10f7:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    10fe:	00 
    ...
    111d:	c7 44 24 04 5c 4b 00 	movl   $0x4b5c,0x4(%esp)
    1124:	00 
    1125:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    112c:	e8 2c 30 00 00       	call   415d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11a9:	05 80 8c 00 00       	add    $0x8c80,%eax
    ...
    11bb:	74 19                	je     11d6 <fourfiles+0x1c7>
          printf(1, "wrong char\n");
    11bd:	c7 44 24 04 6d 4b 00 	movl   $0x4b6d,0x4(%esp)
    11c4:	00 
    11c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11cc:	e8 8c 2f 00 00       	call   415d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ee:	00 
    11ef:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    11f6:	00 
    ...
    1226:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
    122d:	00 
    122e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1235:	e8 23 2f 00 00       	call   415d <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1257:	c7 44 24 04 8a 4b 00 	movl   $0x4b8a,0x4(%esp)
    125e:	00 
    125f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1266:	e8 f2 2e 00 00       	call   415d <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1279:	c7 44 24 04 b4 4b 00 	movl   $0x4bb4,0x4(%esp)
    1280:	00 
    1281:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1288:	e8 d0 2e 00 00       	call   415d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12a5:	79 19                	jns    12c0 <createdelete+0x4d>
      printf(1, "fork failed\n");
    12a7:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
    12ae:	00 
    12af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b6:	e8 a2 2e 00 00       	call   415d <printf>
      exit();
    ...
    1306:	79 19                	jns    1321 <createdelete+0xae>
          printf(1, "create failed\n");
    1308:	c7 44 24 04 4d 4b 00 	movl   $0x4b4d,0x4(%esp)
    130f:	00 
    1310:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1317:	e8 41 2e 00 00       	call   415d <printf>
          exit();
    ...
    135d:	c7 44 24 04 48 46 00 	movl   $0x4648,0x4(%esp)
    1364:	00 
    1365:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    136c:	e8 ec 2d 00 00       	call   415d <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1415:	c7 44 24 04 c8 4b 00 	movl   $0x4bc8,0x4(%esp)
    141c:	00 
    141d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1424:	e8 34 2d 00 00       	call   415d <printf>
        exit();
    ...
    1447:	c7 44 24 04 ec 4b 00 	movl   $0x4bec,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 02 2d 00 00       	call   415d <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14cc:	c7 44 24 04 0c 4c 00 	movl   $0x4c0c,0x4(%esp)
    14d3:	00 
    14d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14db:	e8 7d 2c 00 00       	call   415d <printf>
}
    14e0:	c9                   	leave  
    14e1:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14e8:	c7 44 24 04 1d 4c 00 	movl   $0x4c1d,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f7:	e8 61 2c 00 00       	call   415d <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    14fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1503:	00 
    1504:	c7 04 24 2e 4c 00 00 	movl   $0x4c2e,(%esp)
  ...
  if(fd < 0){
    ...
    1519:	c7 44 24 04 39 4c 00 	movl   $0x4c39,0x4(%esp)
    1520:	00 
    1521:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1528:	e8 30 2c 00 00       	call   415d <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1539:	00 
    153a:	c7 44 24 04 53 4c 00 	movl   $0x4c53,0x4(%esp)
    1541:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    155f:	00 
    1560:	c7 04 24 2e 4c 00 00 	movl   $0x4c2e,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15fb:	00 
    15fc:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    1603:	00 
    ...
    1614:	c7 44 24 04 8f 4c 00 	movl   $0x4c8f,0x4(%esp)
    161b:	00 
    161c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1623:	e8 35 2b 00 00       	call   415d <printf>
    exit();
    1628:	e8 9b 29 00 00       	call   3fc8 <exit>
  }
  if(buf[0] != 'h'){
    162d:	a0 80 8c 00 00       	mov    0x8c80,%al
    1632:	3c 68                	cmp    $0x68,%al
    1634:	74 19                	je     164f <unlinkread+0x16d>
    printf(1, "unlinkread wrong data\n");
    1636:	c7 44 24 04 a6 4c 00 	movl   $0x4ca6,0x4(%esp)
    163d:	00 
    163e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1645:	e8 13 2b 00 00       	call   415d <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1656:	00 
    1657:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    165e:	00 
    ...
    166f:	c7 44 24 04 bd 4c 00 	movl   $0x4cbd,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 da 2a 00 00       	call   415d <printf>
    exit();
  ...
  unlink("unlinkread");
    1693:	c7 04 24 2e 4c 00 00 	movl   $0x4c2e,(%esp)
    169a:	e8 79 29 00 00       	call   4018 <unlink>
  printf(1, "unlinkread ok\n");
    169f:	c7 44 24 04 d6 4c 00 	movl   $0x4cd6,0x4(%esp)
    16a6:	00 
    16a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ae:	e8 aa 2a 00 00       	call   415d <printf>
}
    16b3:	c9                   	leave  
    16b4:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16bb:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    16c2:	00 
    16c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ca:	e8 8e 2a 00 00       	call   415d <printf>

  unlink("lf1");
    16cf:	c7 04 24 ef 4c 00 00 	movl   $0x4cef,(%esp)
    16d6:	e8 3d 29 00 00       	call   4018 <unlink>
  unlink("lf2");
    16db:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
    16e2:	e8 31 29 00 00       	call   4018 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16e7:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    16ee:	00 
    16ef:	c7 04 24 ef 4c 00 00 	movl   $0x4cef,(%esp)
  ...
  if(fd < 0){
    ...
    1704:	c7 44 24 04 f7 4c 00 	movl   $0x4cf7,0x4(%esp)
    170b:	00 
    170c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1713:	e8 45 2a 00 00       	call   415d <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1724:	00 
    1725:	c7 44 24 04 53 4c 00 	movl   $0x4c53,0x4(%esp)
    172c:	00 
    ...
    173d:	c7 44 24 04 0a 4d 00 	movl   $0x4d0a,0x4(%esp)
    1744:	00 
    1745:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    174c:	e8 0c 2a 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
  ...
  if(fd < 0){
    ...
    17ec:	c7 44 24 04 59 4d 00 	movl   $0x4d59,0x4(%esp)
    17f3:	00 
    17f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17fb:	e8 5d 29 00 00       	call   415d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    180c:	00 
    180d:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    1814:	00 
    ...
    1825:	c7 44 24 04 6a 4d 00 	movl   $0x4d6a,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1834:	e8 24 29 00 00       	call   415d <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1849:	c7 44 24 04 f3 4c 00 	movl   $0x4cf3,0x4(%esp)
    1850:	00 
    1851:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
    1858:	e8 cb 27 00 00       	call   4028 <link>
    185d:	85 c0                	test   %eax,%eax
    185f:	78 19                	js     187a <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1861:	c7 44 24 04 7b 4d 00 	movl   $0x4d7b,0x4(%esp)
    1868:	00 
    1869:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1870:	e8 e8 28 00 00       	call   415d <printf>
    exit();
    1875:	e8 4e 27 00 00       	call   3fc8 <exit>
  }

  unlink("lf2");
    187a:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
    1881:	e8 92 27 00 00       	call   4018 <unlink>
  if(link("lf2", "lf1") >= 0){
    1886:	c7 44 24 04 ef 4c 00 	movl   $0x4cef,0x4(%esp)
    188d:	00 
    188e:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
    1895:	e8 8e 27 00 00       	call   4028 <link>
    189a:	85 c0                	test   %eax,%eax
    189c:	78 19                	js     18b7 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    189e:	c7 44 24 04 9c 4d 00 	movl   $0x4d9c,0x4(%esp)
    18a5:	00 
    18a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18ad:	e8 ab 28 00 00       	call   415d <printf>
    exit();
    18b2:	e8 11 27 00 00       	call   3fc8 <exit>
  }

  if(link(".", "lf1") >= 0){
    18b7:	c7 44 24 04 ef 4c 00 	movl   $0x4cef,0x4(%esp)
    18be:	00 
    18bf:	c7 04 24 bf 4d 00 00 	movl   $0x4dbf,(%esp)
    18c6:	e8 5d 27 00 00       	call   4028 <link>
    18cb:	85 c0                	test   %eax,%eax
    18cd:	78 19                	js     18e8 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18cf:	c7 44 24 04 c1 4d 00 	movl   $0x4dc1,0x4(%esp)
    18d6:	00 
    18d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18de:	e8 7a 28 00 00       	call   415d <printf>
    exit();
    18e3:	e8 e0 26 00 00       	call   3fc8 <exit>
  }

  printf(1, "linktest ok\n");
    18e8:	c7 44 24 04 dd 4d 00 	movl   $0x4ddd,0x4(%esp)
    18ef:	00 
    18f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f7:	e8 61 28 00 00       	call   415d <printf>
}
    18fc:	c9                   	leave  
    18fd:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1904:	c7 44 24 04 ea 4d 00 	movl   $0x4dea,0x4(%esp)
    190b:	00 
    190c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1913:	e8 45 28 00 00       	call   415d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1967:	c7 04 24 fa 4d 00 00 	movl   $0x4dfa,(%esp)
    ...
    1994:	c7 04 24 fa 4d 00 00 	movl   $0x4dfa,(%esp)
    ...
    19c5:	c7 44 24 04 fd 4d 00 	movl   $0x4dfd,0x4(%esp)
    19cc:	00 
    19cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19d4:	e8 84 27 00 00       	call   415d <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a28:	00 
    1a29:	c7 04 24 bf 4d 00 00 	movl   $0x4dbf,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1a87:	c7 44 24 04 19 4e 00 	movl   $0x4e19,0x4(%esp)
    1a8e:	00 
    1a8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a96:	e8 c2 26 00 00       	call   415d <printf>
        exit();
    ...
    1ab8:	c7 44 24 04 32 4e 00 	movl   $0x4e32,0x4(%esp)
    1abf:	00 
    1ac0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ac7:	e8 91 26 00 00       	call   415d <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b12:	c7 44 24 04 50 4e 00 	movl   $0x4e50,0x4(%esp)
    1b19:	00 
    1b1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b21:	e8 37 26 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b4c:	79 19                	jns    1b67 <concreate+0x269>
      printf(1, "fork failed\n");
    1b4e:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
    1b55:	00 
    1b56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b5d:	e8 fb 25 00 00       	call   415d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1c4d:	c7 44 24 04 81 4e 00 	movl   $0x4e81,0x4(%esp)
    1c54:	00 
    1c55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c5c:	e8 fc 24 00 00       	call   415d <printf>
}
    1c61:	c9                   	leave  
    1c62:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1c69:	c7 44 24 04 8f 4e 00 	movl   $0x4e8f,0x4(%esp)
    1c70:	00 
    1c71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c78:	e8 e0 24 00 00       	call   415d <printf>

  unlink("x");
    1c7d:	c7 04 24 fb 49 00 00 	movl   $0x49fb,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1c97:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
    1c9e:	00 
    1c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca6:	e8 b2 24 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d24:	00 
    1d25:	c7 04 24 fb 49 00 00 	movl   $0x49fb,(%esp)
    ...
    1d4f:	75 16                	jne    1d67 <linkunlink+0x104>
      link("cat", "x");
    1d51:	c7 44 24 04 fb 49 00 	movl   $0x49fb,0x4(%esp)
    1d58:	00 
    1d59:	c7 04 24 a0 4e 00 00 	movl   $0x4ea0,(%esp)
    1d60:	e8 c3 22 00 00       	call   4028 <link>
    1d65:	eb 0c                	jmp    1d73 <linkunlink+0x110>
    } else {
      unlink("x");
    1d67:	c7 04 24 fb 49 00 00 	movl   $0x49fb,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d92:	c7 44 24 04 a4 4e 00 	movl   $0x4ea4,0x4(%esp)
    1d99:	00 
    1d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1da1:	e8 b7 23 00 00       	call   415d <printf>
}
    1da6:	c9                   	leave  
    1da7:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dae:	c7 44 24 04 b3 4e 00 	movl   $0x4eb3,0x4(%esp)
    1db5:	00 
    1db6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dbd:	e8 9b 23 00 00       	call   415d <printf>
  unlink("bd");
    1dc2:	c7 04 24 c0 4e 00 00 	movl   $0x4ec0,(%esp)
    1dc9:	e8 4a 22 00 00       	call   4018 <unlink>

  fd = open("bd", O_CREATE);
    1dce:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1dd5:	00 
    1dd6:	c7 04 24 c0 4e 00 00 	movl   $0x4ec0,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 c3 4e 00 	movl   $0x4ec3,0x4(%esp)
    1df2:	00 
    1df3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dfa:	e8 5e 23 00 00       	call   415d <printf>
    exit();
  ...
  unlink("bd");
    1e86:	c7 04 24 c0 4e 00 00 	movl   $0x4ec0,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1edc:	c7 44 24 04 ed 4e 00 	movl   $0x4eed,0x4(%esp)
    1ee3:	00 
    1ee4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eeb:	e8 6d 22 00 00       	call   415d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f01:	c7 44 24 04 02 4f 00 	movl   $0x4f02,0x4(%esp)
    1f08:	00 
    1f09:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f10:	e8 48 22 00 00       	call   415d <printf>
}
    1f15:	c9                   	leave  
    1f16:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f1d:	c7 44 24 04 0d 4f 00 	movl   $0x4f0d,0x4(%esp)
    1f24:	00 
    1f25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f2c:	e8 2c 22 00 00       	call   415d <printf>

  unlink("ff");
    1f31:	c7 04 24 1a 4f 00 00 	movl   $0x4f1a,(%esp)
    1f38:	e8 db 20 00 00       	call   4018 <unlink>
  if(mkdir("dd") != 0){
    1f3d:	c7 04 24 1d 4f 00 00 	movl   $0x4f1d,(%esp)
    1f44:	e8 e7 20 00 00       	call   4030 <mkdir>
    1f49:	85 c0                	test   %eax,%eax
    1f4b:	74 19                	je     1f66 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f4d:	c7 44 24 04 20 4f 00 	movl   $0x4f20,0x4(%esp)
    1f54:	00 
    1f55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5c:	e8 fc 21 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f6d:	00 
    1f6e:	c7 04 24 38 4f 00 00 	movl   $0x4f38,(%esp)
  ...
  if(fd < 0){
    ...
    1f83:	c7 44 24 04 3e 4f 00 	movl   $0x4f3e,0x4(%esp)
    1f8a:	00 
    1f8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f92:	e8 c6 21 00 00       	call   415d <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1fa3:	00 
    1fa4:	c7 44 24 04 1a 4f 00 	movl   $0x4f1a,0x4(%esp)
    1fab:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    201b:	00 
    201c:	c7 04 24 9c 4f 00 00 	movl   $0x4f9c,(%esp)
  ...
  if(fd < 0){
    ...
    2031:	c7 44 24 04 a5 4f 00 	movl   $0x4fa5,0x4(%esp)
    2038:	00 
    2039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2040:	e8 18 21 00 00       	call   415d <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    2051:	00 
    2052:	c7 44 24 04 bd 4f 00 	movl   $0x4fbd,0x4(%esp)
    2059:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2077:	00 
    2078:	c7 04 24 c0 4f 00 00 	movl   $0x4fc0,(%esp)
  ...
  if(fd < 0){
    ...
    208d:	c7 44 24 04 cc 4f 00 	movl   $0x4fcc,0x4(%esp)
    2094:	00 
    2095:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    209c:	e8 bc 20 00 00       	call   415d <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20ad:	00 
    20ae:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    20b5:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    20ca:	a0 80 8c 00 00       	mov    0x8c80,%al
    20cf:	3c 66                	cmp    $0x66,%al
    20d1:	74 19                	je     20ec <subdir+0x1d5>
    printf(1, "dd/dd/../ff wrong content\n");
    20d3:	c7 44 24 04 e5 4f 00 	movl   $0x4fe5,0x4(%esp)
    20da:	00 
    20db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20e2:	e8 76 20 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    222d:	00 
    222e:	c7 04 24 00 50 00 00 	movl   $0x5000,(%esp)
  ...
  if(fd < 0){
    ...
    2243:	c7 44 24 04 ca 50 00 	movl   $0x50ca,0x4(%esp)
    224a:	00 
    224b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2252:	e8 06 1f 00 00       	call   415d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2263:	00 
    2264:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    226b:	00 
    ...
    227c:	c7 44 24 04 e2 50 00 	movl   $0x50e2,0x4(%esp)
    2283:	00 
    2284:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    228b:	e8 cd 1e 00 00       	call   415d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2661:	c7 44 24 04 5c 53 00 	movl   $0x535c,0x4(%esp)
    2668:	00 
    2669:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2670:	e8 e8 1a 00 00       	call   415d <printf>

  unlink("bigwrite");
    2675:	c7 04 24 6b 53 00 00 	movl   $0x536b,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2694:	00 
    2695:	c7 04 24 6b 53 00 00 	movl   $0x536b,(%esp)
    ...
    26aa:	c7 44 24 04 74 53 00 	movl   $0x5374,0x4(%esp)
    26b1:	00 
    26b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b9:	e8 9f 1a 00 00       	call   415d <printf>
      exit();
    ...
    26d3:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    26da:	00 
    ...
    26ff:	c7 44 24 04 8c 53 00 	movl   $0x538c,0x4(%esp)
    2706:	00 
    2707:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270e:	e8 4a 1a 00 00       	call   415d <printf>
        exit();
    ...
    unlink("bigwrite");
    272c:	c7 04 24 6b 53 00 00 	movl   $0x536b,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    274c:	c7 44 24 04 9e 53 00 	movl   $0x539e,0x4(%esp)
    2753:	00 
    2754:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275b:	e8 fd 19 00 00       	call   415d <printf>
}
    2760:	c9                   	leave  
    2761:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2768:	c7 44 24 04 ab 53 00 	movl   $0x53ab,0x4(%esp)
    276f:	00 
    2770:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2777:	e8 e1 19 00 00       	call   415d <printf>

  unlink("bigfile");
    277c:	c7 04 24 b9 53 00 00 	movl   $0x53b9,(%esp)
    2783:	e8 90 18 00 00       	call   4018 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2788:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    278f:	00 
    2790:	c7 04 24 b9 53 00 00 	movl   $0x53b9,(%esp)
  ...
  if(fd < 0){
    ...
    27a5:	c7 44 24 04 c1 53 00 	movl   $0x53c1,0x4(%esp)
    27ac:	00 
    27ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27b4:	e8 a4 19 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    27d6:	c7 04 24 80 8c 00 00 	movl   $0x8c80,(%esp)
    27dd:	e8 42 16 00 00       	call   3e24 <memset>
    if(write(fd, buf, 600) != 600){
    27e2:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    27e9:	00 
    27ea:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    27f1:	00 
    ...
    2804:	c7 44 24 04 d7 53 00 	movl   $0x53d7,0x4(%esp)
    280b:	00 
    280c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2813:	e8 45 19 00 00       	call   415d <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    2838:	00 
    2839:	c7 04 24 b9 53 00 00 	movl   $0x53b9,(%esp)
  ...
  if(fd < 0){
    ...
    284e:	c7 44 24 04 ed 53 00 	movl   $0x53ed,0x4(%esp)
    2855:	00 
    2856:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    285d:	e8 fb 18 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    287c:	00 
    287d:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    2884:	00 
    ...
    2899:	c7 44 24 04 02 54 00 	movl   $0x5402,0x4(%esp)
    28a0:	00 
    28a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28a8:	e8 b0 18 00 00       	call   415d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    28dc:	c7 44 24 04 17 54 00 	movl   $0x5417,0x4(%esp)
    28e3:	00 
    28e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28eb:	e8 6d 18 00 00       	call   415d <printf>
      exit();
    28f0:	e8 d3 16 00 00       	call   3fc8 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    28f5:	a0 80 8c 00 00       	mov    0x8c80,%al
    ...
    290d:	a0 ab 8d 00 00       	mov    0x8dab,%al
    ...
    2923:	74 19                	je     293e <bigfile+0x1dc>
      printf(1, "read bigfile wrong data\n");
    2925:	c7 44 24 04 2b 54 00 	movl   $0x542b,0x4(%esp)
    292c:	00 
    292d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2934:	e8 24 18 00 00       	call   415d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    294c:	c7 44 24 04 44 54 00 	movl   $0x5444,0x4(%esp)
    2953:	00 
    2954:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    295b:	e8 fd 17 00 00       	call   415d <printf>
    exit();
    2960:	e8 63 16 00 00       	call   3fc8 <exit>
  }
  unlink("bigfile");
    2965:	c7 04 24 b9 53 00 00 	movl   $0x53b9,(%esp)
    296c:	e8 a7 16 00 00       	call   4018 <unlink>

  printf(1, "bigfile test ok\n");
    2971:	c7 44 24 04 5e 54 00 	movl   $0x545e,0x4(%esp)
    2978:	00 
    2979:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2980:	e8 d8 17 00 00       	call   415d <printf>
}
    2985:	c9                   	leave  
    2986:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29fa:	00 
    29fb:	c7 04 24 fc 54 00 00 	movl   $0x54fc,(%esp)
  ...
  if(fd < 0){
    ...
    2a10:	c7 44 24 04 2c 55 00 	movl   $0x552c,0x4(%esp)
    2a17:	00 
    2a18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a1f:	e8 39 17 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a3b:	00 
    2a3c:	c7 04 24 6c 55 00 00 	movl   $0x556c,(%esp)
  ...
  if(fd < 0){
    ...
    2a51:	c7 44 24 04 9c 55 00 	movl   $0x559c,0x4(%esp)
    2a58:	00 
    2a59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a60:	e8 f8 16 00 00       	call   415d <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2c5b:	c7 44 24 04 33 57 00 	movl   $0x5733,0x4(%esp)
    2c62:	00 
    2c63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6a:	e8 ee 14 00 00       	call   415d <printf>

  fd = open("dirfile", O_CREATE);
    2c6f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2c76:	00 
    2c77:	c7 04 24 40 57 00 00 	movl   $0x5740,(%esp)
  ...
  if(fd < 0){
    ...
    2c8c:	c7 44 24 04 48 57 00 	movl   $0x5748,0x4(%esp)
    2c93:	00 
    2c94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c9b:	e8 bd 14 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ce0:	00 
    2ce1:	c7 04 24 79 57 00 00 	movl   $0x5779,(%esp)
  ...
  if(fd >= 0){
    ...
    2cf6:	c7 44 24 04 84 57 00 	movl   $0x5784,0x4(%esp)
    2cfd:	00 
    2cfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d05:	e8 53 14 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d16:	00 
    2d17:	c7 04 24 79 57 00 00 	movl   $0x5779,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2df8:	00 
    2df9:	c7 04 24 bf 4d 00 00 	movl   $0x4dbf,(%esp)
  ...
  if(fd >= 0){
    ...
    2e0e:	c7 44 24 04 1c 58 00 	movl   $0x581c,0x4(%esp)
    2e15:	00 
    2e16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e1d:	e8 3b 13 00 00       	call   415d <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2e5d:	c7 44 24 04 3b 58 00 	movl   $0x583b,0x4(%esp)
    2e64:	00 
    2e65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6c:	e8 ec 12 00 00       	call   415d <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2e81:	c7 44 24 04 4f 58 00 	movl   $0x584f,0x4(%esp)
    2e88:	00 
    2e89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e90:	e8 c8 12 00 00       	call   415d <printf>
}
    2e95:	c9                   	leave  
    2e96:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2e9d:	c7 44 24 04 5f 58 00 	movl   $0x585f,0x4(%esp)
    2ea4:	00 
    2ea5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2eac:	e8 ac 12 00 00       	call   415d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f5e:	00 
    2f5f:	c7 04 24 9f 58 00 00 	movl   $0x589f,(%esp)
    ...
    unlink("xx");
    2f7f:	c7 04 24 9f 58 00 00 	movl   $0x589f,(%esp)
  ...
  chdir("/");
    2f98:	c7 04 24 96 45 00 00 	movl   $0x4596,(%esp)
    2f9f:	e8 94 10 00 00       	call   4038 <chdir>
  printf(1, "empty file name OK\n");
    2fa4:	c7 44 24 04 a2 58 00 	movl   $0x58a2,0x4(%esp)
    2fab:	00 
    2fac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fb3:	e8 a5 11 00 00       	call   415d <printf>
}
    2fb8:	c9                   	leave  
    2fb9:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2fc0:	c7 44 24 04 b6 58 00 	movl   $0x58b6,0x4(%esp)
    2fc7:	00 
    2fc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fcf:	e8 89 11 00 00       	call   415d <printf>
    ...
    2ff3:	e8 d0 0f 00 00       	call   3fc8 <exit>
{
  ...
  if(n == 1000){
    ...
    300d:	c7 44 24 04 c4 58 00 	movl   $0x58c4,0x4(%esp)
    3014:	00 
    3015:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    301c:	e8 3c 11 00 00       	call   415d <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3031:	c7 44 24 04 e6 58 00 	movl   $0x58e6,0x4(%esp)
    3038:	00 
    3039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3040:	e8 18 11 00 00       	call   415d <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    305d:	c7 44 24 04 fa 58 00 	movl   $0x58fa,0x4(%esp)
    3064:	00 
    3065:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    306c:	e8 ec 10 00 00       	call   415d <printf>
    exit();
    3071:	e8 52 0f 00 00       	call   3fc8 <exit>
  }

  printf(1, "fork test OK\n");
    3076:	c7 44 24 04 0d 59 00 	movl   $0x590d,0x4(%esp)
    307d:	00 
    307e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3085:	e8 d3 10 00 00       	call   415d <printf>
}
    308a:	c9                   	leave  
    308b:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3096:	a1 a4 64 00 00       	mov    0x64a4,%eax
    309b:	c7 44 24 04 1b 59 00 	movl   $0x591b,0x4(%esp)
    30a2:	00 
    30a3:	89 04 24             	mov    %eax,(%esp)
    30a6:	e8 b2 10 00 00       	call   415d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    30e9:	a1 a4 64 00 00       	mov    0x64a4,%eax
    ...
    3103:	c7 44 24 04 26 59 00 	movl   $0x5926,0x4(%esp)
    310a:	00 
    310b:	89 04 24             	mov    %eax,(%esp)
    310e:	e8 4a 10 00 00       	call   415d <printf>
      exit();
  ...
  if(pid < 0){
    ...
    313f:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3144:	c7 44 24 04 41 59 00 	movl   $0x5941,0x4(%esp)
    314b:	00 
    314c:	89 04 24             	mov    %eax,(%esp)
    314f:	e8 09 10 00 00       	call   415d <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3180:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3185:	c7 44 24 04 58 59 00 	movl   $0x5958,0x4(%esp)
    318c:	00 
    318d:	89 04 24             	mov    %eax,(%esp)
    3190:	e8 c8 0f 00 00       	call   415d <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    31de:	a1 a4 64 00 00       	mov    0x64a4,%eax
    31e3:	c7 44 24 04 74 59 00 	movl   $0x5974,0x4(%esp)
    31ea:	00 
    31eb:	89 04 24             	mov    %eax,(%esp)
    31ee:	e8 6a 0f 00 00       	call   415d <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3229:	a1 a4 64 00 00       	mov    0x64a4,%eax
    322e:	c7 44 24 04 b2 59 00 	movl   $0x59b2,0x4(%esp)
    3235:	00 
    3236:	89 04 24             	mov    %eax,(%esp)
    3239:	e8 1f 0f 00 00       	call   415d <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    325f:	a1 a4 64 00 00       	mov    0x64a4,%eax
    ...
    3272:	c7 44 24 04 d0 59 00 	movl   $0x59d0,0x4(%esp)
    3279:	00 
    327a:	89 04 24             	mov    %eax,(%esp)
    327d:	e8 db 0e 00 00       	call   415d <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    32c6:	a1 a4 64 00 00       	mov    0x64a4,%eax
    ...
    32d9:	c7 44 24 04 08 5a 00 	movl   $0x5a08,0x4(%esp)
    32e0:	00 
    32e1:	89 04 24             	mov    %eax,(%esp)
    32e4:	e8 74 0e 00 00       	call   415d <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    32f7:	a1 a4 64 00 00       	mov    0x64a4,%eax
    32fc:	c7 44 24 04 30 5a 00 	movl   $0x5a30,0x4(%esp)
    3303:	00 
    3304:	89 04 24             	mov    %eax,(%esp)
    3307:	e8 51 0e 00 00       	call   415d <printf>
    exit();
  ...
  if(c != a){
    ...
    3346:	a1 a4 64 00 00       	mov    0x64a4,%eax
    ...
    3359:	c7 44 24 04 60 5a 00 	movl   $0x5a60,0x4(%esp)
    3360:	00 
    3361:	89 04 24             	mov    %eax,(%esp)
    3364:	e8 f4 0d 00 00       	call   415d <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    338b:	79 1a                	jns    33a7 <sbrktest+0x31b>
      printf(stdout, "fork failed\n");
    338d:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3392:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
    3399:	00 
    339a:	89 04 24             	mov    %eax,(%esp)
    339d:	e8 bb 0d 00 00       	call   415d <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    340d:	c7 44 24 04 96 49 00 	movl   $0x4996,0x4(%esp)
    3414:	00 
    3415:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    341c:	e8 3c 0d 00 00       	call   415d <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3470:	00 
    3471:	c7 44 24 04 fb 49 00 	movl   $0x49fb,0x4(%esp)
    3478:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    350f:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3514:	c7 44 24 04 9a 5a 00 	movl   $0x5a9a,0x4(%esp)
    351b:	00 
    351c:	89 04 24             	mov    %eax,(%esp)
    351f:	e8 39 0c 00 00       	call   415d <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    3555:	a1 a4 64 00 00       	mov    0x64a4,%eax
    355a:	c7 44 24 04 b5 5a 00 	movl   $0x5ab5,0x4(%esp)
    3561:	00 
    3562:	89 04 24             	mov    %eax,(%esp)
    3565:	e8 f3 0b 00 00       	call   415d <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    359b:	a1 a4 64 00 00       	mov    0x64a4,%eax
    35a0:	c7 44 24 04 c3 5a 00 	movl   $0x5ac3,0x4(%esp)
    35a7:	00 
    35a8:	89 04 24             	mov    %eax,(%esp)
    35ab:	e8 ad 0b 00 00       	call   415d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    360d:	c7 04 24 d2 5a 00 00 	movl   $0x5ad2,(%esp)
    3614:	e8 0f 0a 00 00       	call   4028 <link>
    3619:	83 f8 ff             	cmp    $0xffffffff,%eax
    361c:	74 1a                	je     3638 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    361e:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3623:	c7 44 24 04 dd 5a 00 	movl   $0x5add,0x4(%esp)
    362a:	00 
    362b:	89 04 24             	mov    %eax,(%esp)
    362e:	e8 2a 0b 00 00       	call   415d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    364b:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3650:	c7 44 24 04 f6 5a 00 	movl   $0x5af6,0x4(%esp)
    3657:	00 
    3658:	89 04 24             	mov    %eax,(%esp)
    365b:	e8 fd 0a 00 00       	call   415d <printf>
}
    3660:	c9                   	leave  
    3661:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3668:	a1 a4 64 00 00       	mov    0x64a4,%eax
    366d:	c7 44 24 04 03 5b 00 	movl   $0x5b03,0x4(%esp)
    3674:	00 
    3675:	89 04 24             	mov    %eax,(%esp)
    3678:	e8 e0 0a 00 00       	call   415d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    367d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3684:	eb 2b                	jmp    36b1 <bsstest+0x4f>
    if(uninit[i] != '\0'){
    3686:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3689:	05 60 65 00 00       	add    $0x6560,%eax
    368e:	8a 00                	mov    (%eax),%al
    3690:	84 c0                	test   %al,%al
    3692:	74 1a                	je     36ae <bsstest+0x4c>
      printf(stdout, "bss test failed\n");
    3694:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3699:	c7 44 24 04 0d 5b 00 	movl   $0x5b0d,0x4(%esp)
    36a0:	00 
    36a1:	89 04 24             	mov    %eax,(%esp)
    36a4:	e8 b4 0a 00 00       	call   415d <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    36bb:	a1 a4 64 00 00       	mov    0x64a4,%eax
    36c0:	c7 44 24 04 1e 5b 00 	movl   $0x5b1e,0x4(%esp)
    36c7:	00 
    36c8:	89 04 24             	mov    %eax,(%esp)
    36cb:	e8 8d 0a 00 00       	call   415d <printf>
}
    36d0:	c9                   	leave  
    36d1:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    36d8:	c7 04 24 2b 5b 00 00 	movl   $0x5b2b,(%esp)
  ...
  if(pid == 0){
    ...
    3702:	c7 04 85 c0 64 00 00 	movl   $0x5b38,0x64c0(,%eax,4)
    3709:	38 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3714:	7e e9                	jle    36ff <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    3716:	c7 05 3c 65 00 00 00 	movl   $0x0,0x653c
    371d:	00 00 00 
    printf(stdout, "bigarg test\n");
    3720:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3725:	c7 44 24 04 15 5c 00 	movl   $0x5c15,0x4(%esp)
    372c:	00 
    372d:	89 04 24             	mov    %eax,(%esp)
    3730:	e8 28 0a 00 00       	call   415d <printf>
    exec("echo", args);
    3735:	c7 44 24 04 c0 64 00 	movl   $0x64c0,0x4(%esp)
    373c:	00 
    373d:	c7 04 24 24 45 00 00 	movl   $0x4524,(%esp)
    3744:	e8 b7 08 00 00       	call   4000 <exec>
    printf(stdout, "bigarg test ok\n");
    3749:	a1 a4 64 00 00       	mov    0x64a4,%eax
    374e:	c7 44 24 04 22 5c 00 	movl   $0x5c22,0x4(%esp)
    3755:	00 
    3756:	89 04 24             	mov    %eax,(%esp)
    3759:	e8 ff 09 00 00       	call   415d <printf>
    fd = open("bigarg-ok", O_CREATE);
    375e:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3765:	00 
    3766:	c7 04 24 2b 5b 00 00 	movl   $0x5b2b,(%esp)
    ...
    378b:	a1 a4 64 00 00       	mov    0x64a4,%eax
    3790:	c7 44 24 04 32 5c 00 	movl   $0x5c32,0x4(%esp)
    3797:	00 
    3798:	89 04 24             	mov    %eax,(%esp)
    379b:	e8 bd 09 00 00       	call   415d <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    37b1:	00 
    37b2:	c7 04 24 2b 5b 00 00 	movl   $0x5b2b,(%esp)
  ...
  if(fd < 0){
    ...
    37c7:	a1 a4 64 00 00       	mov    0x64a4,%eax
    37cc:	c7 44 24 04 4b 5c 00 	movl   $0x5c4b,0x4(%esp)
    37d3:	00 
    37d4:	89 04 24             	mov    %eax,(%esp)
    37d7:	e8 81 09 00 00       	call   415d <printf>
    exit();
  ...
  unlink("bigarg-ok");
    37ec:	c7 04 24 2b 5b 00 00 	movl   $0x5b2b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3808:	c7 44 24 04 60 5c 00 	movl   $0x5c60,0x4(%esp)
    380f:	00 
    3810:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3817:	e8 41 09 00 00       	call   415d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    390c:	c7 44 24 04 6d 5c 00 	movl   $0x5c6d,0x4(%esp)
    3913:	00 
    3914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    391b:	e8 3d 08 00 00       	call   415d <printf>
    ...
    3943:	c7 44 24 04 79 5c 00 	movl   $0x5c79,0x4(%esp)
    394a:	00 
    394b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3952:	e8 06 08 00 00       	call   415d <printf>
      break;
    ...
    3967:	00 
    3968:	c7 44 24 04 80 8c 00 	movl   $0x8c80,0x4(%esp)
    396f:	00 
    ...
    398f:	c7 44 24 04 89 5c 00 	movl   $0x5c89,0x4(%esp)
    3996:	00 
    3997:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399e:	e8 ba 07 00 00       	call   415d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3aca:	c7 44 24 04 99 5c 00 	movl   $0x5c99,0x4(%esp)
    3ad1:	00 
    3ad2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ad9:	e8 7f 06 00 00       	call   415d <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3af4:	c7 44 24 04 af 5c 00 	movl   $0x5caf,0x4(%esp)
    3afb:	00 
    3afc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b03:	e8 55 06 00 00       	call   415d <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b38:	c7 44 24 04 bc 5c 00 	movl   $0x5cbc,0x4(%esp)
    3b3f:	00 
    3b40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b47:	e8 11 06 00 00       	call   415d <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b57:	c7 44 24 04 c5 45 00 	movl   $0x45c5,0x4(%esp)
    3b5e:	00 
    3b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b66:	e8 f2 05 00 00       	call   415d <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3b75:	c7 44 24 04 dd 5c 00 	movl   $0x5cdd,0x4(%esp)
    3b7c:	00 
    3b7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b84:	e8 d4 05 00 00       	call   415d <printf>
}
    3b89:	c9                   	leave  
    3b8a:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3b98:	00 
    3b99:	c7 04 24 ec 5c 00 00 	movl   $0x5cec,(%esp)
  ...
  if (fd < 0) {
    ...
    3bae:	c7 44 24 04 f1 5c 00 	movl   $0x5cf1,0x4(%esp)
    3bb5:	00 
    3bb6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bbd:	e8 9b 05 00 00       	call   415d <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3bf6:	c7 44 24 04 fe 5c 00 	movl   $0x5cfe,0x4(%esp)
    3bfd:	00 
    3bfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c05:	e8 53 05 00 00       	call   415d <printf>
}
    3c0a:	c9                   	leave  
    3c0b:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c0f:	8b 15 a8 64 00 00    	mov    0x64a8,%edx
    ...
    3c4a:	a3 a8 64 00 00       	mov    %eax,0x64a8
  return randstate;
    3c4f:	a1 a8 64 00 00       	mov    0x64a8,%eax
}
    3c54:	5d                   	pop    %ebp
    3c55:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cab:	00 
    3cac:	c7 04 24 23 5d 00 00 	movl   $0x5d23,(%esp)
...
00004078 <pipe_count>:
SYSCALL(pipe_count)
    4078:	b8 18 00 00 00       	mov    $0x18,%eax
    407d:	cd 40                	int    $0x40
    407f:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    4083:	83 ec 18             	sub    $0x18,%esp
    4086:	8b 45 0c             	mov    0xc(%ebp),%eax
    4089:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    408c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    4093:	00 
    4094:	8d 45 f4             	lea    -0xc(%ebp),%eax
    4097:	89 44 24 04          	mov    %eax,0x4(%esp)
    409b:	8b 45 08             	mov    0x8(%ebp),%eax
    409e:	89 04 24             	mov    %eax,(%esp)
    40a1:	e8 42 ff ff ff       	call   3fe8 <write>
}
    40a6:	c9                   	leave  
    40a7:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    40b0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    40b7:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    40bb:	74 17                	je     40d4 <printint+0x2c>
    40bd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    40c1:	79 11                	jns    40d4 <printint+0x2c>
    neg = 1;
    40c3:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    40ca:	8b 45 0c             	mov    0xc(%ebp),%eax
    40cd:	f7 d8                	neg    %eax
    40cf:	89 45 ec             	mov    %eax,-0x14(%ebp)
    40d2:	eb 06                	jmp    40da <printint+0x32>
  } else {
    x = xx;
    40d4:	8b 45 0c             	mov    0xc(%ebp),%eax
    40d7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    40da:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    40e1:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    40e4:	8d 41 01             	lea    0x1(%ecx),%eax
    40e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    40ea:	8b 5d 10             	mov    0x10(%ebp),%ebx
    40ed:	8b 45 ec             	mov    -0x14(%ebp),%eax
    40f0:	ba 00 00 00 00       	mov    $0x0,%edx
    40f5:	f7 f3                	div    %ebx
    40f7:	89 d0                	mov    %edx,%eax
    40f9:	8a 80 ac 64 00 00    	mov    0x64ac(%eax),%al
    40ff:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4103:	8b 75 10             	mov    0x10(%ebp),%esi
    4106:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4109:	ba 00 00 00 00       	mov    $0x0,%edx
    410e:	f7 f6                	div    %esi
    4110:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4113:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4117:	75 c8                	jne    40e1 <printint+0x39>
  if(neg)
    4119:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    411d:	74 10                	je     412f <printint+0x87>
    buf[i++] = '-';
    411f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4122:	8d 50 01             	lea    0x1(%eax),%edx
    4125:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4128:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    412d:	eb 1e                	jmp    414d <printint+0xa5>
    412f:	eb 1c                	jmp    414d <printint+0xa5>
    putc(fd, buf[i]);
    4131:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4134:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4137:	01 d0                	add    %edx,%eax
    4139:	8a 00                	mov    (%eax),%al
    413b:	0f be c0             	movsbl %al,%eax
    413e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4142:	8b 45 08             	mov    0x8(%ebp),%eax
    4145:	89 04 24             	mov    %eax,(%esp)
    4148:	e8 33 ff ff ff       	call   4080 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    414d:	ff 4d f4             	decl   -0xc(%ebp)
    4150:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4154:	79 db                	jns    4131 <printint+0x89>
    putc(fd, buf[i]);
}
    4156:	83 c4 30             	add    $0x30,%esp
    4159:	5b                   	pop    %ebx
    415a:	5e                   	pop    %esi
    415b:	5d                   	pop    %ebp
    415c:	c3                   	ret    
...
{
    415d:	55                   	push   %ebp
    415e:	89 e5                	mov    %esp,%ebp
    4160:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4163:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    416a:	8d 45 0c             	lea    0xc(%ebp),%eax
    416d:	83 c0 04             	add    $0x4,%eax
    4170:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4173:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    417a:	e9 77 01 00 00       	jmp    42f6 <printf+0x199>
    c = fmt[i] & 0xff;
    417f:	8b 55 0c             	mov    0xc(%ebp),%edx
    4182:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4185:	01 d0                	add    %edx,%eax
    4187:	8a 00                	mov    (%eax),%al
    4189:	0f be c0             	movsbl %al,%eax
    418c:	25 ff 00 00 00       	and    $0xff,%eax
    4191:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    4194:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4198:	75 2c                	jne    41c6 <printf+0x69>
      if(c == '%'){
    419a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    419e:	75 0c                	jne    41ac <printf+0x4f>
        state = '%';
    41a0:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41a7:	e9 47 01 00 00       	jmp    42f3 <printf+0x196>
      } else {
        putc(fd, c);
    41ac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41af:	0f be c0             	movsbl %al,%eax
    41b2:	89 44 24 04          	mov    %eax,0x4(%esp)
    41b6:	8b 45 08             	mov    0x8(%ebp),%eax
    41b9:	89 04 24             	mov    %eax,(%esp)
    41bc:	e8 bf fe ff ff       	call   4080 <putc>
    41c1:	e9 2d 01 00 00       	jmp    42f3 <printf+0x196>
      }
    } else if(state == '%'){
    41c6:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    41ca:	0f 85 23 01 00 00    	jne    42f3 <printf+0x196>
      if(c == 'd'){
    41d0:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    41d4:	75 2d                	jne    4203 <printf+0xa6>
        printint(fd, *ap, 10, 1);
    41d6:	8b 45 e8             	mov    -0x18(%ebp),%eax
    41d9:	8b 00                	mov    (%eax),%eax
    41db:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    41e2:	00 
    41e3:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    41ea:	00 
    41eb:	89 44 24 04          	mov    %eax,0x4(%esp)
    41ef:	8b 45 08             	mov    0x8(%ebp),%eax
    41f2:	89 04 24             	mov    %eax,(%esp)
    41f5:	e8 ae fe ff ff       	call   40a8 <printint>
        ap++;
    41fa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    41fe:	e9 e9 00 00 00       	jmp    42ec <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
    4203:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4207:	74 06                	je     420f <printf+0xb2>
    4209:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    420d:	75 2d                	jne    423c <printf+0xdf>
        printint(fd, *ap, 16, 0);
    420f:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4212:	8b 00                	mov    (%eax),%eax
    4214:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    421b:	00 
    421c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4223:	00 
    4224:	89 44 24 04          	mov    %eax,0x4(%esp)
    4228:	8b 45 08             	mov    0x8(%ebp),%eax
    422b:	89 04 24             	mov    %eax,(%esp)
    422e:	e8 75 fe ff ff       	call   40a8 <printint>
        ap++;
    4233:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4237:	e9 b0 00 00 00       	jmp    42ec <printf+0x18f>
      } else if(c == 's'){
    423c:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4240:	75 42                	jne    4284 <printf+0x127>
        s = (char*)*ap;
    4242:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4245:	8b 00                	mov    (%eax),%eax
    4247:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    424a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    424e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4252:	75 09                	jne    425d <printf+0x100>
          s = "(null)";
    4254:	c7 45 f4 5e 5d 00 00 	movl   $0x5d5e,-0xc(%ebp)
        while(*s != 0){
    425b:	eb 1c                	jmp    4279 <printf+0x11c>
    425d:	eb 1a                	jmp    4279 <printf+0x11c>
          putc(fd, *s);
    425f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4262:	8a 00                	mov    (%eax),%al
    4264:	0f be c0             	movsbl %al,%eax
    4267:	89 44 24 04          	mov    %eax,0x4(%esp)
    426b:	8b 45 08             	mov    0x8(%ebp),%eax
    426e:	89 04 24             	mov    %eax,(%esp)
    4271:	e8 0a fe ff ff       	call   4080 <putc>
          s++;
    4276:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    427c:	8a 00                	mov    (%eax),%al
    427e:	84 c0                	test   %al,%al
    4280:	75 dd                	jne    425f <printf+0x102>
    4282:	eb 68                	jmp    42ec <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4284:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4288:	75 1d                	jne    42a7 <printf+0x14a>
        putc(fd, *ap);
    428a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    428d:	8b 00                	mov    (%eax),%eax
    428f:	0f be c0             	movsbl %al,%eax
    4292:	89 44 24 04          	mov    %eax,0x4(%esp)
    4296:	8b 45 08             	mov    0x8(%ebp),%eax
    4299:	89 04 24             	mov    %eax,(%esp)
    429c:	e8 df fd ff ff       	call   4080 <putc>
        ap++;
    42a1:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42a5:	eb 45                	jmp    42ec <printf+0x18f>
      } else if(c == '%'){
    42a7:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42ab:	75 17                	jne    42c4 <printf+0x167>
        putc(fd, c);
    ...
    42bd:	e8 be fd ff ff       	call   4080 <putc>
    42c2:	eb 28                	jmp    42ec <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    42c4:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    42cb:	00 
    42cc:	8b 45 08             	mov    0x8(%ebp),%eax
    42cf:	89 04 24             	mov    %eax,(%esp)
    42d2:	e8 a9 fd ff ff       	call   4080 <putc>
        putc(fd, c);
    ...
    42e7:	e8 94 fd ff ff       	call   4080 <putc>
      }
      state = 0;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    42f3:	ff 45 f0             	incl   -0x10(%ebp)
    42f6:	8b 55 0c             	mov    0xc(%ebp),%edx
    42f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    42fc:	01 d0                	add    %edx,%eax
    42fe:	8a 00                	mov    (%eax),%al
    4300:	84 c0                	test   %al,%al
    4302:	0f 85 77 fe ff ff    	jne    417f <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
{
    430c:	55                   	push   %ebp
    430d:	89 e5                	mov    %esp,%ebp
    430f:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4312:	8b 45 08             	mov    0x8(%ebp),%eax
    4315:	83 e8 08             	sub    $0x8,%eax
    4318:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    431b:	a1 48 65 00 00       	mov    0x6548,%eax
    4320:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4323:	eb 24                	jmp    4349 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4325:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4328:	8b 00                	mov    (%eax),%eax
    432a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    432d:	77 12                	ja     4341 <free+0x35>
    432f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4332:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4335:	77 24                	ja     435b <free+0x4f>
    4337:	8b 45 fc             	mov    -0x4(%ebp),%eax
    433a:	8b 00                	mov    (%eax),%eax
    433c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    433f:	77 1a                	ja     435b <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    4346:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4349:	8b 45 f8             	mov    -0x8(%ebp),%eax
    434c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    434f:	76 d4                	jbe    4325 <free+0x19>
    4351:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4354:	8b 00                	mov    (%eax),%eax
    4356:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4359:	76 ca                	jbe    4325 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    435b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    435e:	8b 40 04             	mov    0x4(%eax),%eax
    4361:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4368:	8b 45 f8             	mov    -0x8(%ebp),%eax
    436b:	01 c2                	add    %eax,%edx
    436d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4370:	8b 00                	mov    (%eax),%eax
    4372:	39 c2                	cmp    %eax,%edx
    4374:	75 24                	jne    439a <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    4376:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4379:	8b 50 04             	mov    0x4(%eax),%edx
    437c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    ...
    4391:	8b 10                	mov    (%eax),%edx
    4393:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4396:	89 10                	mov    %edx,(%eax)
    4398:	eb 0a                	jmp    43a4 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
    ...
    43f0:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    43f3:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    43fa:	77 07                	ja     4403 <morecore+0x16>
    nu = 4096;
    43fc:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4403:	8b 45 08             	mov    0x8(%ebp),%eax
    4406:	c1 e0 03             	shl    $0x3,%eax
    4409:	89 04 24             	mov    %eax,(%esp)
    440c:	e8 3f fc ff ff       	call   4050 <sbrk>
    4411:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4414:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4418:	75 07                	jne    4421 <morecore+0x34>
    return 0;
    441a:	b8 00 00 00 00       	mov    $0x0,%eax
    441f:	eb 22                	jmp    4443 <morecore+0x56>
  hp = (Header*)p;
  ...
  free((void*)(hp + 1));
    ...
    4439:	e8 ce fe ff ff       	call   430c <free>
  return freep;
    443e:	a1 48 65 00 00       	mov    0x6548,%eax
}
    4443:	c9                   	leave  
    4444:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4448:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    444b:	8b 45 08             	mov    0x8(%ebp),%eax
    444e:	83 c0 07             	add    $0x7,%eax
    4451:	c1 e8 03             	shr    $0x3,%eax
    4454:	40                   	inc    %eax
    4455:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4458:	a1 48 65 00 00       	mov    0x6548,%eax
    445d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4460:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4464:	75 23                	jne    4489 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    4466:	c7 45 f0 40 65 00 00 	movl   $0x6540,-0x10(%ebp)
    446d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4470:	a3 48 65 00 00       	mov    %eax,0x6548
    4475:	a1 48 65 00 00       	mov    0x6548,%eax
    447a:	a3 40 65 00 00       	mov    %eax,0x6540
    base.s.size = 0;
    447f:	c7 05 44 65 00 00 00 	movl   $0x0,0x6544
    4486:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4497:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    449a:	72 4d                	jb     44e9 <malloc+0xa4>
      if(p->s.size == nunits)
    449c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    449f:	8b 40 04             	mov    0x4(%eax),%eax
    44a2:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44a5:	75 0c                	jne    44b3 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    44a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44aa:	8b 10                	mov    (%eax),%edx
    44ac:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44af:	89 10                	mov    %edx,(%eax)
    44b1:	eb 26                	jmp    44d9 <malloc+0x94>
      else {
        p->s.size -= nunits;
    44b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44b6:	8b 40 04             	mov    0x4(%eax),%eax
    44b9:	2b 45 ec             	sub    -0x14(%ebp),%eax
    44bc:	89 c2                	mov    %eax,%edx
    44be:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44c1:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    44c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44c7:	8b 40 04             	mov    0x4(%eax),%eax
    44ca:	c1 e0 03             	shl    $0x3,%eax
    44cd:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    44d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44d3:	8b 55 ec             	mov    -0x14(%ebp),%edx
    44d6:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    44d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44dc:	a3 48 65 00 00       	mov    %eax,0x6548
      return (void*)(p + 1);
    44e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44e4:	83 c0 08             	add    $0x8,%eax
    44e7:	eb 38                	jmp    4521 <malloc+0xdc>
    }
    if(p == freep)
    44e9:	a1 48 65 00 00       	mov    0x6548,%eax
    44ee:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    44f1:	75 1b                	jne    450e <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    44f3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    44f6:	89 04 24             	mov    %eax,(%esp)
    44f9:	e8 ef fe ff ff       	call   43ed <morecore>
    44fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4501:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4505:	75 07                	jne    450e <malloc+0xc9>
        return 0;
    4507:	b8 00 00 00 00       	mov    $0x0,%eax
    450c:	eb 13                	jmp    4521 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    451c:	e9 70 ff ff ff       	jmp    4491 <malloc+0x4c>
}
    4521:	c9                   	leave  
    4522:	c3                   	ret    
